...
#[test]
fn m3_tracker_remains_complete_while_the_ci_reliability_side_quest_is_active() {
    ...
    assert!(project.contains("no later main-story milestone is active"));
    assert!(project.contains("| SIDE-007 | Redesign the README as a polished, terminal-first public product page | P2 | Codex | Done |"));
    assert!(project.contains("| SIDE-008 | Eliminate duplicate pull-request CI and stabilize Windows health-process fixture timing | P2 | Codex | In progress |"));
